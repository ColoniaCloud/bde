...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_status" AS ENUM('available', 'out-of-stock', 'on-request');
  CREATE TYPE "public"."enum_categories_tone" AS ENUM('peach', 'rose', 'sand', 'green', 'berry', 'orange');
  ...
  CREATE TABLE "products" (
  	...
  	"old_price" numeric,
  	"discount" numeric,
  	"status" "enum_products_status" DEFAULT 'available' NOT NULL,
  	"tag" varchar,
  ...
  CREATE TABLE "categories" (
  	...
  	"tone" "enum_categories_tone" NOT NULL,
  	"description" varchar NOT NULL,
